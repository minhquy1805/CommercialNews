...
public sealed class NotificationsEmailSentOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public NotificationsEmailSentOutboxHandler(
        IOutboxEventPublisher publisher)
    {
        _publisher = publisher ?? throw new ArgumentNullException(nameof(publisher));
    }

    public string EventType => NotificationsIntegrationEventTypes.EmailSent;
