...
public sealed class InteractionArticleUnlikedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public InteractionArticleUnlikedOutboxHandler(
    ...
    public string EventType =>
        InteractionIntegrationEventTypes.ArticleUnliked;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: InteractionIntegrationEventTypes.ArticleUnliked,
                cancellationToken);
