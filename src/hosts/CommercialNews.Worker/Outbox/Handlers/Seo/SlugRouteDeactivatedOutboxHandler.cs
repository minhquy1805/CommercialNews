...
public sealed class SlugRouteDeactivatedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public SlugRouteDeactivatedOutboxHandler(
    ...
    public string EventType =>
        SeoIntegrationEventTypes.SlugRouteDeactivated;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: SeoIntegrationEventTypes.SlugRouteDeactivated,
                cancellationToken);
