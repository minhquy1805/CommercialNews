...
public sealed class SeoMetadataUpdatedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public SeoMetadataUpdatedOutboxHandler(
    ...
    public string EventType =>
        SeoIntegrationEventTypes.MetadataUpdated;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: SeoIntegrationEventTypes.MetadataUpdated,
                cancellationToken);
