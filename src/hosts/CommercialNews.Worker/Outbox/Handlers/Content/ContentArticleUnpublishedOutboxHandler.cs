...
public sealed class ContentArticleUnpublishedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public ContentArticleUnpublishedOutboxHandler(
    ...
    public string EventType =>
        ContentIntegrationEventTypes.ArticleUnpublished;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: ContentIntegrationEventTypes.ArticleUnpublished,
                cancellationToken);
