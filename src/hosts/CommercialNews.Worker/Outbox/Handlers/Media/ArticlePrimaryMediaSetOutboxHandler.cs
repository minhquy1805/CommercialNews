...
public sealed class ArticlePrimaryMediaSetOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public ArticlePrimaryMediaSetOutboxHandler(
    ...
    public string EventType =>
        MediaIntegrationEventTypes.ArticlePrimaryMediaSet;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: MediaIntegrationEventTypes.ArticlePrimaryMediaSet,
                cancellationToken);
