...
public sealed class IdentityPasswordChangedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public IdentityPasswordChangedOutboxHandler(
    ...
    public string EventType =>
        IdentityIntegrationEventTypes.PasswordChanged;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: IdentityIntegrationEventTypes.PasswordChanged,
                cancellationToken);
