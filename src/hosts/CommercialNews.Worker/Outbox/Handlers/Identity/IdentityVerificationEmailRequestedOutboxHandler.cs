...
public sealed class IdentityVerificationEmailRequestedOutboxHandler
    : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public IdentityVerificationEmailRequestedOutboxHandler(
    ...
    public string EventType =>
        IdentityIntegrationEventTypes.VerificationEmailRequested;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: IdentityIntegrationEventTypes.VerificationEmailRequested,
                cancellationToken);
