...
public sealed class IdentityUserLockedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public IdentityUserLockedOutboxHandler(
    ...
    public string EventType =>
        IdentityIntegrationEventTypes.UserLocked;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: IdentityIntegrationEventTypes.UserLocked,
                cancellationToken);
