...
public sealed class IdentityEmailMarkedVerifiedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public IdentityEmailMarkedVerifiedOutboxHandler(
    ...
    public string EventType =>
        IdentityIntegrationEventTypes.EmailMarkedVerified;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: IdentityIntegrationEventTypes.EmailMarkedVerified,
                cancellationToken);
