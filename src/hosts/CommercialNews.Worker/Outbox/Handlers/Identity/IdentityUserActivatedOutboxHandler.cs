...
public sealed class IdentityUserActivatedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public IdentityUserActivatedOutboxHandler(
    ...
    public string EventType =>
        IdentityIntegrationEventTypes.UserActivated;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: IdentityIntegrationEventTypes.UserActivated,
                cancellationToken);
