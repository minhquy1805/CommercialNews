...
public sealed class IdentityPasswordResetRequestedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public IdentityPasswordResetRequestedOutboxHandler(
    ...
    public string EventType =>
        IdentityIntegrationEventTypes.PasswordResetRequested;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: IdentityIntegrationEventTypes.PasswordResetRequested,
                cancellationToken);
