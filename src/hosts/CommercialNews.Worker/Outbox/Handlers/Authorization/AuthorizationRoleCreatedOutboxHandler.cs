...
public sealed class AuthorizationRoleCreatedOutboxHandler : IOutboxMessageHandler
{
    private readonly IOutboxEventPublisher _publisher;

    public AuthorizationRoleCreatedOutboxHandler(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Result<PublishOutboxEventResult> publishResult =
            await _publisher.PublishAsync(
                outboxMessage,
                routingKey: AuthorizationIntegrationEventTypes.RoleCreated,
                cancellationToken);
