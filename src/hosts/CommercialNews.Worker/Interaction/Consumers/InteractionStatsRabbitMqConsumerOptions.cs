...
public sealed class InteractionStatsRabbitMqConsumerOptions
{
    public const string SectionName = "RabbitMq:InteractionStatsConsumer";
    ...
    public string QueueName { get; init; } = "interaction.stats.materialization";
    ...
    public string ConsumerTag { get; init; } =
        "CommercialNews.Interaction.Stats.Consumer";
