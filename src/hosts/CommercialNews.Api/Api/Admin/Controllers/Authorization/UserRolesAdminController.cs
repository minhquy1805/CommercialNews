...
public sealed class UserRolesAdminController : ControllerBase
{
    ...
    {
        Result<AssignRoleToUserResponseDto> result =
            await _assignRoleToUserUseCase.ExecuteAsync(
    ...
    public async Task<IActionResult> RevokeRoleFromUser(
        ...
        CancellationToken cancellationToken)
    {
        Result<RevokeRoleFromUserResponseDto> result =
            await _revokeRoleFromUserUseCase.ExecuteAsync(
    ...
    public async Task<IActionResult> GetUserRoles(
        ...
        CancellationToken cancellationToken)
    {
        Result<GetUserRolesResponseDto> result =
            await _getUserRolesUseCase.ExecuteAsync(
    ...
    private static AssignRoleToUserHttpResponse MapAssignRoleToUserResponse(
        AssignRoleToUserResponseDto source)
    {
    ...
    private static RevokeRoleFromUserHttpResponse MapRevokeRoleFromUserResponse(
        RevokeRoleFromUserResponseDto source)
    {
    ...
    private static GetUserRolesHttpResponse MapGetUserRolesResponse(
        GetUserRolesResponseDto source)
    {
