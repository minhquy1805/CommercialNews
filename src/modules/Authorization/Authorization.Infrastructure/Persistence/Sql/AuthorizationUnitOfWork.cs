...
{
    public sealed class AuthorizationUnitOfWork : IAuthorizationUnitOfWork, IAsyncDisposable
    {
        ...
        public AuthorizationUnitOfWork(AuthorizationSqlConnectionFactory connectionFactory)
        {
