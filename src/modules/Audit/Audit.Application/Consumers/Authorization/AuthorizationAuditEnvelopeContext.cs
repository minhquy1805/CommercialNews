...
public sealed class AuthorizationAuditEnvelopeContext
{
    ...
    public static AuthorizationAuditEnvelopeContext Create(
        string messageId,
        string eventType,
    ...
    {
        return new AuthorizationAuditEnvelopeContext
        {
            MessageId = messageId,
            EventType = eventType,
