...
public sealed class GetFailedAuditIngestionListQueryValidator
    : AbstractValidator<GetFailedAuditIngestionListQuery>
{
    ...
    public GetFailedAuditIngestionListQueryValidator()
    {
